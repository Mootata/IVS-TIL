...
// 구조체를 매개변수로 받는 함수 정의
int calculate_1(Data const *data)
{
...
int main()
{
    ...
    int result_2 = calculate_2(myData.var1, myData.var2, myData.var3, myData.var4, myData.var5, myData.var6, myData.var7, myData.var8, myData.var9, myData.var10, myData.var11, myData.var12, myData.var13, myData.var14, myData.var15);
    printf("결과_1: %d\n", result_1);
    printf("결과_2: %d\n", result_2);
    return 0;
}